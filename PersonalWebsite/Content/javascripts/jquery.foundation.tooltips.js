      ...
      reposition : function (target, tip, classes) {
        ...
        if ($(window).width() < 767) {
          ...
          if (classes && classes.indexOf('tip-top') > -1) {
            ...
            /* top-position fixed by Adam K Dean / Imdsm */
            objPos(tip, (target.offset().top + (target.outerHeight() / 2) - (tip.outerHeight() / 2) + (nubHeight / 2)), 'auto', 'auto', (target.offset().left - tip.outerWidth() - 10), width)
              .removeClass('tip-override');
            objPos(nub, (tip.outerHeight() / 2) - (nubHeight / 2), -nubHeight, 'auto', 'auto');          
          } else if (classes && classes.indexOf('tip-right') > -1) {
             /* top-position fixed by Adam K Dean / Imdsm */
             objPos(tip, (target.offset().top + (target.outerHeight() / 2) - (tip.outerHeight() / 2) + (nubHeight / 2)), 'auto', 'auto', (target.offset().left + target.outerWidth() + 10), width)
               .removeClass('tip-override');
            objPos(nub, (tip.outerHeight() / 2) - (nubHeight), 'auto', 'auto', -nubHeight);          
